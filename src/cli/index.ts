...
program
  ...
  .option('--schema <name>', 'Set the workflow schema (e.g., analytics-eng, spec-driven)')
  .option('--force', 'Auto-cleanup legacy files without prompting')
  .option('--profile <profile>', 'Override global config profile (core or custom)')
  .action(async (targetPath = '.', options?: { tools?: string; schema?: string; force?: boolean; profile?: string }) => {
    try {
